...
\begin{frame}
	...
	\note{
		...
		\item[] Ab einem gewissen Grad der Schädigung werden die Korallenriffe zunehmende absterben, selbst wenn sich CO2 Gehalt und Temperatur nicht weiter erhöhen, da Hitzestress dauerhaft zu hoch ist
		\end{itemize}
	}
\end{frame}