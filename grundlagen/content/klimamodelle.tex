\begin{frame}
	...
	\begin{itemize}
		...
		\item Strömungslehre und Chemie werden berücksichtigt.
	...
	\note{
		\begin{itemize}
			...
			\item[] Das erste Klimamodell enthielt Atmosphäre, Ozean, Landmassen und Seeeis, deckte aber nur \sfrac{1}{6} der Erdoberfläche ab (Nordpol bis Äquator über einen Winkel von \SI{120}{\degree}).
