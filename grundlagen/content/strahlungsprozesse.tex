...
\begin{frame}
    ...
    \begin{columns}
      ...
      \begin{tikzpicture}
        ...
        \onslide<2>\draw[red,ultra thick,rounded corners] (0.05,0.15) rectangle (0.95,0.285);
        \onslide<3>\draw[red,ultra thick,rounded corners] (0.05,0.285) rectangle (0.95,0.715);
        \onslide<4>\draw[red,ultra thick,rounded corners] (0.05,0.715) rectangle (0.95,0.855);
        \onslide<5>\draw[red,ultra thick,rounded corners] (0.05,0.855) rectangle (0.95,0.96);
    \end{scope}
      \end{tikzpicture}
