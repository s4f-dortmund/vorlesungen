...
\begin{frame}
	...
	\note<1>{
	Aufbau der Atmosphäre, verschiedene Temperatur-, Druck- und Höhenbereiche
	}
  ...
  \note<2>{
    ...
    \begin{itemize}
      \item[] extrem geringe Teilchendichte, Weltraum fängt bei \SI{100}{km} an (NASA), Bremswirkung der Atmosphäre aber auch bei \SI{400}{km} Höhe noch spührbar (ISS wird regelmäßig von andockenden Raumschiffen auf ihre Bahn zurück geschoben)
    \end{itemize}
