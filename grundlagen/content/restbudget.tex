\begin{frame}
  ...
  \begin{columns}
    ...
    \only<1|handout:0>{
      \begin{itemize}
        \item[] Temperaturerhöhung gegen kummulierte CO$_2$-Emissionen
      \end{itemize}
    }
    \only<2|handout:0>{
      \begin{itemize}
    ...
    \only<3|handout:0>{
      \begin{itemize}
        \item[2010] \SI{0.97}{\degreeCelsius} Erwärmung und
                    \SI{1930}{\GtCO} Emittiert
        \item[2017] \SI{1.10}{C} Erwärmung und
                    \SI{2220}{\GtCO} Emittiert
      \end{itemize}
    }
    \only<4-|handout:1>{
      \begin{itemize}
    ...
    \vspace{-2em}
      ...
      \begin{itemize}
        ...
        \item Dünne schwarze Linie zeigt Rekonstruktion mittels der CMIP5 Modelle.
      \end{itemize}
      }
      \note<2-4>{
      \begin{itemize}
