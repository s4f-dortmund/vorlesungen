...
\begin{frame}
    ...
    \begin{columns}
      ...
      \column{0.5\linewidth}
		    \includegraphics[width=.9\linewidth]{bilder/atmosphaere-stockwerkaufbau_bildungsserver_hh.jpg}
...
% z.B. Abbildung über Verweildauer in der Atmosphäre IPCC 2014 Kapitel 8 Anhang 8.A
		\begin{figure}
			\centering
			\includegraphics[width=.8\linewidth]{bilder/IPCC_GWP_anthropogenic_emissions.jpg}
			\caption{Globale von Menschen verursachte Emissionen sortiert nach Klimawirksamkeit (Global Warming Potential, GWP), Quelle: IPCC 2014, Kapitel 8}
		\end{figure}
