...
\begin{frame}[t]
	...
	\begin{itemize}
		...
		\item[] Daten auch für verschiedene Orte auf der Welt verfügbar
	\end{itemize}
	\vspace{1em}
	\begin{itemize}
		\item[1916] Letzte große Antarktis-Expedition unter der Leitung von Ernest Shackleton (Endurance-Expedition). Ziel: Den Kontinent durchqueren. Die Expedition scheiterte, ist aber besonders bekannt, da alle Expeditionsmitglieder unter äußerst widrigen Umständen überlebten.
		\item[] Albert Einstein veröffentlicht die allgemeine Relativitätstheorie.
		\item[] immer mehr Wetterstationen -> genauere Messungen möglich. Darauf kommen wir später noch einmal zurück.
	\end{itemize}
	}
\end{frame}
