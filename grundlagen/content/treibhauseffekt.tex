...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{itemize}
			\item Licht wird hier als Welle betrachten
			\item Welle gekennzeichnet durch Wellenlänge $\lambda$
			\item Normales Licht besteht aus Überlagerung von vielen Wellen mit unterschiedlicher Wellenlänge
			\item Unterschiedlichen Wellenlängen nehmen wir als Farben wahr
			...
			\end{itemize}
			\item Sonne: Hauptsächlich sichtbares Licht, weniger Infrarot und UV
		\end{itemize}
	\column[t]{0.5\linewidth}
